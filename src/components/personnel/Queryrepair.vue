        ...
        <el-card>
            ...
            <el-dialog title="接取报修单" :visible="editDialogVisible" width="50%" @close="editDialogClosed" :close-on-click-modal="false">
                ...
                <span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="editRepair" :disabled="disableBtn">接取报修单</el-button>
                </span>
            </el-dialog>
        </el-card>
    </div>
...
export default {
    ...
    methods:{
        ...
        async editRepair(){
            this.submitForm.personnelid = this.PerInfo.id;
            this.submitForm.personnelname = this.PerInfo.name;
            this.submitForm.personnelphone = this.PerInfo.phone;
